...
SECRET_KEY = 'django-insecure-7(&2@zfuky+c16lia($%#l)*(+9j!50=dcnyy*oxe8mhsb4&_='

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', 'https')

ALLOWED_HOSTS = ['*' ,'run.yuanchuangyuan.cn',"localhost"]
...
MIDDLEWARE = [
    ...
    'edu_system.middleware.GlobalExceptionHandlerMiddleware'
]
...
#             'filename': '/root/mo/edu_system/django_error.log',
#         },
#     },
#     'formatters': {
#         'custom': {
